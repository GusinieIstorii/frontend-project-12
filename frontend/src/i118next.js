...
i18nextInstance
  ...
  .init({
    lng: 'ru',
    debug: true,
    // значение true, чтобы получить вывод в консоль браузера,
    // когда в i18next происходят определенные события,
    // такие как завершение инициализации или изменение языка.
    resources: {
      ru,
